...
def adaptation_cost(ach_baseline, ach_intervention, grid_population, phi, floor_area, occupamcy):
    ...
    cost_sqft_m, cost_sqft_l, cost_sqft_u = adaptation_cost_function( ach_reduction )

    cost_sqft = np.random.triangular(left=cost_sqft_l, mode=cost_sqft_m, right=cost_sqft_u, size=1)
...
def run_MCS(intervention_function = intervention_calculator, HF = 'HF_3', rr = 0.0058, rr_sd = 0.001, iterations = 10):
    ...
    for n in range(iterations):
        ...
        for g in grid_key_list:
            ...
            sample_RR = np.random.normal(RR, RR_sd)
            
            if HF == 'HF_1':
                dY[g] = HF_1(Y_0_dict[g], sample_RR, -delta_mean_C_in[g], psi)
            elif HF == 'HF_2':
                dY[g] = HF_2(Y_0_dict[g], sample_RR, -delta_mean_C_in[g], psi)
            elif HF == 'HF_3':
                #print(sample_RR)
                dY[g] = HF_3(Y_0_dict[g], sample_RR, -delta_mean_C_in[g], psi)
            ...
            #print('init: ',VSL[0])
            #VSL[0] = 8705114
            #print('secondary: ',VSL[0])
            VSL_2023 = VSL[0] * 1.23
            
            #print(VSL_2023)
            
            benefit[g] = health_benefit_calculator(dMort[g], VSL_2023)
    ...
    return list_delta_mean_C_in, list_dMort, list_benefit, list_dY, list_cost, list_NB, list_FINF0, list_FINF1, list_ACHN0, list_ACHN1
